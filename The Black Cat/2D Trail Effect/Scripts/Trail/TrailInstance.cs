...
namespace BlackCatTrail
{
    public class TrailInstance : MonoBehaviour
    {
        ...
        [Tooltip("The size type of the starting size.\n" +
            "- If \"FOLLOW_REAL_SIZE\" is selected, the scale will be set to be the world scale of the game object that is spawning the trail.\n" +
            "- if \"FIXED_SIZE\" is selected, the scale will be set to the fixed scale you provided.")]
        ...
        [Tooltip("The size type of the ending size.\n" +
            "- If \"FOLLOW_REAL_SIZE\" is selected, the scale will be set to the world scale of the game object spawning the trail.\n" +
            "- if \"FIXED_SIZE\" is selected, the scale will be set to the fixed scale you provided.")]
